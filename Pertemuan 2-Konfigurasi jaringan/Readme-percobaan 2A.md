...
+------------------+
   ...
   2. Apa fungsi dari perintah WiFi.mode(WIFI_STA) pada program tersebut?
      WiFi.mode(WIFI_STA) berfungsi untuk mengatur ESP32 agar bekerja dalam mode Station (STA).Pada mode ini,

 ESP32 berperan sebagai perangkat/klien yang terhubung ke jaringan WiFi yang sudah tersedia, seperti hotspot smartphone atau router
